...
const ShowStoreFromCategory = ({navigation, route}) => {
  ...
  const getData = async () => {
    ...
    if (std == '랭킹') {
      axios
        .get(
          `http://ec2-44-217-88-206.compute-1.amazonaws.com:3000/menus/category/${food}/score`,
        )
      ...
      axios
        .get(
          `http://ec2-44-217-88-206.compute-1.amazonaws.com:3000/menus/category/${food}/review_count`,
        )
        .then(function (response) {
          setList(response.data);
        });
      ...
      axios
        .get(
          `http://ec2-44-217-88-206.compute-1.amazonaws.com:3000/menus/category/${food}/tip`,
        )
        .then(function (response) {
          setList(response.data);
        });
...
export default ShowStoreFromCategory;
